...
func TestRaceEndpoints(t *testing.T) {
	...
	test.Get("/api/race").
		...
		Type("json").
		JSON("{\"page\":{\"isDescending\":0,\"limit\":1,\"offset\":0,\"orderBy\":\"name\",\"total\":731},\"races\":[{\"ID\":2253,\"female\":\"PPOINT\",\"icon\":\"xa xa-octopus\",\"male\":\"PPOINT\",\"name\":\"(2253-PPOINT)\",\"neutral\":\"PPOINT\"}]}").
		Done()
	/*&NpcsResponse{
		Npcs: []*model.Npc{
			{
