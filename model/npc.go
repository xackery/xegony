...
type Npc struct {
	...
	SpecialAbilitiesList map[string]string `json:"specialAbilitiesList"`
	...
	RaceID              int64          `json:"raceID" db:"race"`                               //`race` smallint(5) unsigned NOT NULL DEFAULT '0',
	ClassID             int64          `json:"classID" db:"class"`                             //`class` tinyint(2) unsigned NOT NULL DEFAULT '0',
