...
type Spawn struct {
	...
	Dist         float64 `json:"dist,omitempty" db:"dist"`                  //`dist` float NOT NULL DEFAULT '0',
	...
	MinDelay     int64   `json:"minDelay,omitempty" db:"mindelay"`          //`mindelay` int(11) NOT NULL DEFAULT '15000',
