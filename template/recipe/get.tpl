    ...
    <div class="col-lg-4">
        <div class="hpanel forum-box">            
            <div class="panel-heading">
                <span class="f"><a href="/spell">Recipe</a> > {{.Recipe.Name.String}}</span>
            </div>

            <div class="panel-body">                
                <span class="slot slotdrop"><span alt="{{.Recipe.Name.String}}" class="item icon-{{.Recipe.Icon}}"></span></span>            
            <br/>
            <br/>
        
                <h3>{{.Recipe.Name.String}}</h3>
            </div>
            <div class="panel-body">
    ...
    <div class="col-lg-4">
        <div class="hpanel forum-box">
            ...
            <div class="panel-footer">
                {{len .Items}} items have the {{.Recipe.Name.String}} effect
            </div>
        </div>
