...
type Storage interface {
	...
	//Error
	GetError(errorID int64) (error *model.Error, err error)
	CreateError(error *model.Error) (err error)
	ListError(pageSize int64, pageNumber int64) (errors []*model.Error, err error)
	ListErrorCount() (count int64, err error)
	ListErrorByScope(scope string) (errors []*model.Error, err error)
	SearchError(search string) (errors []*model.Error, err error)
	EditError(errorID int64, error *model.Error) (err error)
	DeleteError(errorID int64) (err error)
	//Faction
	...
	//Fishing
	GetFishing(fishingID int64) (fishing *model.Fishing, err error)
	...
	ListFishingByItem(itemID int64) (fishings []*model.Fishing, err error)
	ListFishingByNpc(npcID int64) (fishings []*model.Fishing, err error)
